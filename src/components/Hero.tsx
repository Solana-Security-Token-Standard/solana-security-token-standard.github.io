...
export function Hero() {
  return (
    <div className="overflow-hidden bg-[#2A2D6E] dark:-mt-19 dark:-mb-32 dark:pt-19 dark:pb-32">
        ...
        <div className="mx-auto grid max-w-2xl grid-cols-1 items-center gap-x-8 gap-y-16 px-4 lg:max-w-8xl lg:grid-cols-2 lg:px-8 xl:gap-x-16 xl:px-12">
          <div className="relative z-10 md:text-center lg:text-left">
            ...
            <div className="relative">
              <p className="inline bg-linear-to-r from-[#E0E0E0] via-[#00A8A8] to-[#E0E0E0] bg-clip-text font-display text-5xl tracking-tight text-transparent">
                Build compliant token workflows on Solana.
              </p>
              <p className="mt-3 text-2xl tracking-tight text-slate-400">
                SSTS combines Token-2022 extensions, verification programs, and
                issuer tooling for security token issuance and lifecycle
                operations.
              </p>
          ...
          <div className="relative lg:static xl:pl-10">
            ...
            <div className="relative">
              ...
              <Image
                ...
                priority
              />
              <div className="absolute inset-0 rounded-2xl bg-linear-to-tr from-[#00A8A8] via-[#00A8A8]/70 to-[#2A2D6E] opacity-15 blur-lg" />
              <div className="absolute inset-0 rounded-2xl bg-linear-to-tr from-[#00A8A8] via-[#00A8A8]/70 to-[#2A2D6E] opacity-15" />
              <div className="relative rounded-2xl bg-[#0A101F]/80 ring-1 ring-white/10 backdrop-blur-sm">
                <div className="absolute -top-px right-11 left-20 h-px bg-linear-to-r from-[#00A8A8]/0 via-[#00A8A8]/70 to-[#00A8A8]/0" />
                <div className="absolute right-20 -bottom-px left-11 h-px bg-linear-to-r from-[#2A2D6E]/0 via-[#00A8A8] to-[#2A2D6E]/0" />
                    ...
                    {tabs.map((tab) => (
                      <div
                        ...
                        className={clsx(
                          ...
                          tab.isActive
                            ? 'bg-linear-to-r from-[#00A8A8]/30 via-[#00A8A8] to-[#00A8A8]/30 p-px font-medium text-[#E0E0E0]'
                            : 'text-slate-500',
                        )}
                      >
                        <div
